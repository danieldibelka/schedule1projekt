...
<head>
    ...
    <title>Weed | Váš Databázový Projekt</title>
...
<body>
    ...
    <main>
        <section>
            ...
            $sql = "SELECT id, name, prod_cost, water_needs, grow_difficulty, light_needs FROM weed";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<thead>";
                echo "<tr><th>ID</th><th>Název</th><th>Výrobní náklady</th><th>Potřeba vody</th><th>Obtížnost pěstování</th><th>Potřeba světla</th></tr>";
                echo "</thead>";
                echo "<tbody>";
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["water_needs"] . "</td>";
                    echo "<td>" . $row["grow_difficulty"] . "</td>";
                    echo "<td>" . $row["light_needs"] . "</td>";
                    echo "</tr>";
                }
                echo "</tbody>";
                echo "</table>";
            } else {
                echo "<p>Žádné druhy Weedu nebyly nalezeny v databázi.</p>";
            }
